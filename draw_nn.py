...
# ------------------------------------------------------------
# Add text labels
plt.text(x1, 2.7, "Input-lager", ha='center', va='top')
plt.text(x2, 2.7, r"Gomt-lager\\\\ $a_j=f(\sum_{i=1}^N w_{ij} x_i + b_j)$",
         ha='center', va='top')
plt.text(x3, 2.7, r"Output-lager\\\\ $o_k=g(\sum_{j=1}^M w_{jk} a_j + b_k)$",
         ha='center', va='top')
